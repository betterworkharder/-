...
// 2026年6月18日刊 - 丰行慧运情报中心当前最新内容
export const CATEGORIES: TrendCategory[] = reorderCategories(JUNE_18_CATEGORIES);
  ...
  },
  {
    ...
    "categories": [
      ...
      },
      {
        ...
        "title": "技术与能力演进",
        "icon": "Cpu",
        "description": "聚焦技术范式、能力体系和应用路径 of 演进，识别影响行业效率、产品边界 and 竞争门槛的关键变化。重点判断相关能力从概念走向规模化落地所需达到的成熟度，呈现技术演进对产业能力结构的影响。",
        "news": [
          {
            "id": "pt26-6",
